    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Photo,Price,Stock,CategoryId")] Product product, IFormFile Photo)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    // upload işlemi yapmak için önce konum belirle
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,Stock,CategoryId")] Product product, IFormFile Photo)
        {
            if (id != product.Id)
            {
                return NotFound();
